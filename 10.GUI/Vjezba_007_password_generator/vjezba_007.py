...
# -- -- Radiobuttons
rb_prikazi_lozinku = tk.Radiobutton(lbl_frm_postavke, text="Prikazi generiranu lozinku", variable=prikazi_lozinku, value="prikazi", command=set_prikaz_lozinke).grid(column=0, row=1)
rb_sakrij_lozinku = tk.Radiobutton(lbl_frm_postavke, text="Sakrij generiranu lozinku", variable=prikazi_lozinku, value="sakrij", command=set_prikaz_lozinke).grid(column=2, row=1)

# -- -- Klizac za duzinu lozinke
klizac_duzina = tk.Scale(lbl_frm_postavke, orient="horizontal", variable=duzina_lozinke, length=300, from_=8, to=40, command=set_duzina_lozinke)
